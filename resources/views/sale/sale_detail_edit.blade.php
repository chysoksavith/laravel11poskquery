                    ...
                    <div class="card mb-4 p-2">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ url('admin/sales/sale_detail_list/'.$getRecord->sale_id) }}" class="btn btn-primary">Back</a>
                            </div>
                        </div>
                        <div class="mt-1">
                            <div class="row">
                                <div class="col-md-6">
                                    <div>
                                        <form method="post" action="">
                                            @csrf
                                            <input type="hidden" name="sale_id" value="{{ $getRecord->sale_id }}">
                                            <!-- Select product -->
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('selling_price', $getRecord->selling_price) }}">
                                                @error('selling_price')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('discount', $getRecord->discount) }}">
                                                @error('discount')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="d-grid gap-1">
                                                ...
                                                <a href="{{ url('admin/sales/sale_detail_list/' . $getRecord->sale_id) }}"
